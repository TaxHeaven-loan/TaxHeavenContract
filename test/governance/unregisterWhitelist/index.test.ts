...
import {
    proposeUnregisterWhitelist,
    applyUnregisterWhitelistProposal,
    getInfoUnregisterWhitelist,
} from './util';
...
contract('Governance', (accounts) => {
    ...
    describe('proposeDelistWhitelist', () => {
        it('works well', async () => {
            ...
            const newParameters = {
                tokenAddress: lendingTokenInstance.address,
            };
            ...
            try {
                const res = await proposeUnregisterWhitelist(proposer, newParameters, {
                    governanceInstance,
                    taxTokenInstance,
                });
    ...
    describe('applyGovernanceForDelistWhitelist', () => {
        const initialTaxTokenSupplyE0 = 20000;
    ...
    describe('getInfoDelistWhitelist', () => {
        const initialTaxTokenSupplyE0 = 20000;
        ...
        it('returns correct values', async () => {
            ...
            const { proposeId } = await proposeUnregisterWhitelist(proposer, newParameters, {
                governanceInstance,
                taxTokenInstance,
            });

            const parametersProposal = await getInfoUnregisterWhitelist(proposeId, {
                governanceInstance,
            });
